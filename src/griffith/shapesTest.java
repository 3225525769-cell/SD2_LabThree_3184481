...
import static org.junit.jupiter.api.Assertions.*;
 ...
 public class shapesTest {
    ...
    void testRightAngleTriangle() {
        RightAngledTriangle rightAngledTriangle = new RightAngledTriangle("RightAngleTriangle",3.0,4.0);
        assertEquals(6.0,rightAngledTriangle.area(),EPSILON);
        assertEquals(12.0,rightAngledTriangle.perimeter(),EPSILON);
        assertEquals("Shape:RightAngleTriangle, Base:3.0,Height:4.0",rightAngledTriangle.toString());
    }
}